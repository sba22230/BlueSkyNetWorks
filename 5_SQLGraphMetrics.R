...
arrow::write_parquet(sql_metrics, "graphs/speirgorm_metrics_from_sql.parquet")
cat("  ✓ SQL metrics saved to graphs/speirgorm_metrics_from_sql.parquet\n")

# Save comparison for analysis
arrow::write_parquet(comparison, "graphs/speirgorm_metrics_comparison.parquet")
cat("  ✓ Comparison saved to graphs/speirgorm_metrics_comparison.parquet\n")

# Save subgraph edges and nodes
arrow::write_parquet(subgraph_edges, "graphs/speirgorm_subgraph_edges.parquet")
arrow::write_parquet(subgraph_nodes, "graphs/speirgorm_subgraph_nodes.parquet")
