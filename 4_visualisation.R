...
scaled_z <- min_coord_range +
  ((vis_nodes$reposts_made - min(vis_nodes$reposts_made)) /
    (max(vis_nodes$reposts_made) - min(vis_nodes$reposts_made))) *
    (max_coord_range - min_coord_range)
