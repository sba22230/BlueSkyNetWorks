...
# nodes_with_metrics <- arrow::read_parquet("docs/graphs/speirgorm_nodes_with_metrics.parquet")
...
arrow::write_parquet(
  sql_metrics,
  "docs/graphs/speirgorm_metrics_from_sql.parquet"
)
cat(
...
arrow::write_parquet(
  comparison,
  "docs/graphs/speirgorm_metrics_comparison.parquet"
)
cat(
...
arrow::write_parquet(
  subgraph_edges,
  "docs/graphs/speirgorm_subgraph_edges.parquet"
)
arrow::write_parquet(
  subgraph_nodes,
  "docs/graphs/speirgorm_subgraph_nodes.parquet"
)
